...
def encrypt(message, key, keylen=16, save_file_name='aes.bin', mode='ecb', initial_vector=''):
    ...
    message, key, num_of_rounds, iv = helper.initial_process(message, key, keylen, initial_vector)  #message,key, iv: những danh sách các sô codepoint
